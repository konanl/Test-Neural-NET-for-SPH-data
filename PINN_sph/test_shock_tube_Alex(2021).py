...
"""
@Project ：PINN_sph 
@File    ：test_shock_tube_Alex(2021).py
@Author  ：LiangL. Yan
@Date    ：2023/3/16 15:41 
"""
"""
...
def main():
    ...
    scipy.io.savemat('./work/shock_tube/Sod_Shock_Tube_pinn.mat', {'x': x, 't': t, 'rho': u_pred[:, 0],
                                                              'u': u_pred[:, 2],
                                                              'p': u_pred[:, 1]})
...
if __name__ == '__main__':
    ...
    data = scipy.io.loadmat("./work/shock_tube/Sod_Shock_Tube_pinn.mat")
    ...
    # print(x_test[:, 1][::1000])
    # print(data['u'])
    plt.plot(x_test[:, 1][9999::1000], data['p'][0][9999::1000])
    plt.savefig('./work/shock_tube/Alex_Code_Sod_Shock_Tube_Predict_p_pinn.png')
    plt.show()
